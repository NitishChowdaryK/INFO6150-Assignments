...
Then theres the way the project puts together semantic HTML elements. It also uses forms and media, along with tables. And external CSS for styling, which makes it look decent. That part gets a bit technical, but its good to see how they fit.
...
- `article`: Displays the main schedule content
